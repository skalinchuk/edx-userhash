#!/usr/bin/env python
"""
Package metadata for edx_userhash.
"""
import os
import re
import sys
...
VERSION = get_version('edx_userhash', '__init__.py')
...
setup(
    name='edx-userhash',
    version=VERSION,
    description="""Create and store unique hash per each user""",
    long_description=README + '\n\n' + CHANGELOG,
    author='RaccoonGang',
    author_email='sergii.kalinchuk@raccoongang.com',
    url='https://github.com/openedx/repo_name',
    packages=find_packages(
        include=['edx_userhash', 'edx_userhash.*'],
        exclude=["*tests"],
    ),
